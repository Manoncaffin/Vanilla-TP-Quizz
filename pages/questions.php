...
<body class="bg-dark text-center">
    <div class="container mt-5 text-center">
        ...
        <div class="card bg-primary-subtle ">
            ...
            <div class="text-center ">
                <b>
                    <p class="fw-3 text-success myQuestion">QUESTION <?php echo $questions['id'] ?> /10</p>
                </b>
            </div>
            ...
            <form id="quizForm" action="../process/answer_verif.php" method="POST">
                ...
                <ul class="list-unstyled p-1 ">
                    ...
                    <li class="border border-dark rounded shadow bg-info">
                        <div class="d-flex justify-content-between px-2 align-items-center">
                            ...
                            <div><input type="radio" class="answer1" name="answer1" value="<?php echo $sum[0] ?>" onclick="verifierAnswer()"> </div>
                        </div>
                    </li>
                ...
                <div class="w-2 p-2 d-flex justify-content-between">
                    ...
                    <div class="btn bg-success d-flex align-items-center"><b>score : <span id="score"> <?php echo $_SESSION['score']?> </span>/10</b></div>
    ...
    //         let radioBtn = document.getElementsByClassName("answer1");
