...
<body class="bg-black">
    <div class="container mt-5 sizeMyBox  d-flex justify-content-center ">
        <div class="card bg-primary-subtle ">
            ...
            <div class="text-center ">
               <b><p class="fw-3 text-success">QUESTION <?php echo $questions['id'] ?> /10</p></b> 
            </div>
            ...
            <form name="quiz" id="quizForm" action="../process/answer_verif.php" method="POST">
                ...
                <div class="w-2 p-2 d-flex justify-content-between">
                    ...
                    <input type="submit" name="submit" class="bg-info btn fs-5" value="suivant ">
            </form>
        </div>
    </div>
    </div>
    ...
    <script>
     ...
     function verifierAnswer(){
        var radioBtn = document.getElementsByClassName("answer");
